...
export default function QuranError({ error, reset }: Props) {
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center gap-6 px-4 text-center">
      ...
      <div className="space-y-2">
        <h1 className="text-2xl font-bold">تعذّر تحميل القرآن الكريم</h1>
        <p className="text-muted-foreground text-sm max-w-sm">
          حدث خطأ أثناء جلب بيانات السورة. تحقق من اتصالك بالإنترنت وحاول مجدداً.
        </p>
      </div>
